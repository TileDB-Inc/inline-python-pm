# This Makefile is for the Inline::Python extension to perl.
#
...
#
#   MakeMaker ARGV: (q[CC=gcc])
#

#   MakeMaker Parameters:

#     ABSTRACT_FROM => q[Python.pod]
#     AUTHOR => [q[Neil Watkiss <NEILW@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DEFINE => q[-DEXPOSE_PERL -DCREATE_PYTHON -UCREATE_PERL]
#     INC => q[-I/opt/conda/include/python3.9/ -I/opt/conda/x86_64-conda-linux-gnu/sysroot/usr/include/]
#     LIBS => q[-L/opt/conda/lib -lpython3.9 -lcrypt -lpthread -ldl  -lutil -lrt -lm]
#     LICENSE => q[perl]
#     META_MERGE => { meta-spec=>{ version=>q[2] }, resources=>{ repository=>{ type=>q[git], url=>q[http://github.com/niner/inline-python-pm.git], web=>q[http://github.com/niner/inline-python-pm] } } }
#     NAME => q[Inline::Python]
#     OBJECT => q[Python.o py2pl.o perlmodule.o util.o]
#     PREREQ_PM => { Data::Dumper=>q[0], Digest::MD5=>q[2.5], File::Spec=>q[0], Inline=>q[0.46], Proc::ProcessTable=>q[0.53], Test=>q[0], Test::Deep=>q[0], Test::More=>q[0], Test::Number::Delta=>q[0] }
#     TEST_REQUIRES => { Proc::ProcessTable=>q[0.53], Test=>q[0], Test::Deep=>q[0], Test::More=>q[0], Test::Number::Delta=>q[0] }
#     VERSION_FROM => q[Python.pm]
#     clean => { FILES=>q[blib_test/] }
...
# These definitions are from config.sh (via /opt/conda/lib/perl5/5.32/core_perl/Config.pm).
# They may have been overridden via Makefile.PL or on the command line.
AR = x86_64-conda-linux-gnu-ar
CC = gcc
CCCDLFLAGS = -fPIC --sysroot=/opt/conda/bin/..//x86_64-conda-linux-gnu/sysroot
CCDLFLAGS = -Wl,-E -Wl,-rpath,/opt/conda/bin/../lib/perl5/5.32/core_perl/CORE
CPPRUN = /opt/conda/bin/..//bin/x86_64-conda-linux-gnu-gcc  --sysroot=/opt/conda/bin/..//x86_64-conda-linux-gnu/sysroot -E
DLEXT = so
DLSRC = dl_dlopen.xs
EXE_EXT = 
FULL_AR = /opt/conda/bin/..//bin/x86_64-conda-linux-gnu-ar
LD = /opt/conda/bin/..//bin/x86_64-conda-linux-gnu-gcc
LDDLFLAGS = -shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/opt/conda/lib -Wl,-rpath-link,/opt/conda/lib -L/opt/conda/lib --sysroot=/opt/conda/bin/..//x86_64-conda-linux-gnu/sysroot -fstack-protector-strong
LDFLAGS = -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/opt/conda/lib -Wl,-rpath-link,/opt/conda/lib -L/opt/conda/lib  -fstack-protector-strong
LIBC = 
LIB_EXT = .a
OBJ_EXT = .o
OSNAME = linux
...
RANLIB = :
SITELIBEXP = /opt/conda/lib/perl5/site_perl
SITEARCHEXP = /opt/conda/lib/perl5/5.32/site_perl
SO = so
VENDORARCHEXP = /opt/conda/lib/perl5/5.32/vendor_perl
VENDORLIBEXP = /opt/conda/lib/perl5/vendor_perl
...
DESTDIR = 
PREFIX = $(SITEPREFIX)
PERLPREFIX = /opt/conda/bin/..
SITEPREFIX = /opt/conda/bin/..
VENDORPREFIX = /opt/conda
INSTALLPRIVLIB = /opt/conda/lib/perl5/core_perl
DESTINSTALLPRIVLIB = $(DESTDIR)$(INSTALLPRIVLIB)
INSTALLSITELIB = /opt/conda/lib/perl5/site_perl
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = /opt/conda/lib/perl5/vendor_perl
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = /opt/conda/lib/perl5/5.32/core_perl
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /opt/conda/lib/perl5/5.32/site_perl
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = /opt/conda/lib/perl5/5.32/vendor_perl
DESTINSTALLVENDORARCH = $(DESTDIR)$(INSTALLVENDORARCH)
INSTALLBIN = /opt/conda/bin
DESTINSTALLBIN = $(DESTDIR)$(INSTALLBIN)
INSTALLSITEBIN = /opt/conda/bin
DESTINSTALLSITEBIN = $(DESTDIR)$(INSTALLSITEBIN)
INSTALLVENDORBIN = /opt/conda/bin
DESTINSTALLVENDORBIN = $(DESTDIR)$(INSTALLVENDORBIN)
INSTALLSCRIPT = /opt/conda/bin
DESTINSTALLSCRIPT = $(DESTDIR)$(INSTALLSCRIPT)
INSTALLSITESCRIPT = /opt/conda/bin
DESTINSTALLSITESCRIPT = $(DESTDIR)$(INSTALLSITESCRIPT)
INSTALLVENDORSCRIPT = /opt/conda/bin
DESTINSTALLVENDORSCRIPT = $(DESTDIR)$(INSTALLVENDORSCRIPT)
INSTALLMAN1DIR = /opt/conda/man/man1
DESTINSTALLMAN1DIR = $(DESTDIR)$(INSTALLMAN1DIR)
INSTALLSITEMAN1DIR = /opt/conda/man/man1
DESTINSTALLSITEMAN1DIR = $(DESTDIR)$(INSTALLSITEMAN1DIR)
INSTALLVENDORMAN1DIR = /opt/conda/man/man1
DESTINSTALLVENDORMAN1DIR = $(DESTDIR)$(INSTALLVENDORMAN1DIR)
INSTALLMAN3DIR = /opt/conda/man/man3
DESTINSTALLMAN3DIR = $(DESTDIR)$(INSTALLMAN3DIR)
INSTALLSITEMAN3DIR = /opt/conda/man/man3
DESTINSTALLSITEMAN3DIR = $(DESTDIR)$(INSTALLSITEMAN3DIR)
INSTALLVENDORMAN3DIR = /opt/conda/man/man3
DESTINSTALLVENDORMAN3DIR = $(DESTDIR)$(INSTALLVENDORMAN3DIR)
PERL_LIB = /opt/conda/lib/perl5/core_perl
PERL_ARCHLIB = /opt/conda/lib/perl5/5.32/core_perl
PERL_ARCHLIBDEP = /opt/conda/lib/perl5/5.32/core_perl
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /opt/conda/lib/perl5/5.32/core_perl/CORE
PERL_INCDEP = /opt/conda/lib/perl5/5.32/core_perl/CORE
PERL = "/opt/conda/bin/perl"
FULLPERL = "/opt/conda/bin/perl"
ABSPERL = $(PERL)
PERLRUN = $(PERL)
...
MAKEMAKER   = /opt/conda/lib/perl5/vendor_perl/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.70
MM_REVISION = 77000
...
MAKE = make
FULLEXT = Inline/Python
BASEEXT = Python
PARENT_NAME = Inline
DLBASE = $(BASEEXT)
VERSION_FROM = Python.pm
INC = -I/opt/conda/include/python3.9/ -I/opt/conda/x86_64-conda-linux-gnu/sysroot/usr/include/
DEFINE = -DEXPOSE_PERL -DCREATE_PYTHON -UCREATE_PERL
OBJECT = Python$(OBJ_EXT) py2pl$(OBJ_EXT) perlmodule$(OBJ_EXT) util$(OBJ_EXT)
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
XSUBPPDIR = /opt/conda/lib/perl5/core_perl/ExtUtils
XSUBPP = "$(XSUBPPDIR)$(DFSEP)xsubpp"
XSUBPPRUN = $(PERLRUN) $(XSUBPP)
XSPROTOARG = 
XSUBPPDEPS = /opt/conda/lib/perl5/core_perl/ExtUtils/typemap /opt/conda/lib/perl5/core_perl/ExtUtils$(DFSEP)xsubpp
XSUBPPARGS = -typemap '/opt/conda/lib/perl5/core_perl/ExtUtils/typemap'
XSUBPP_EXTRA_ARGS =
...
DISTNAME = Inline-Python
DISTVNAME = Inline-Python-0.57
...
CCFLAGS = -D_REENTRANT -D_GNU_SOURCE -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /opt/conda/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/perl_1703310062586/work=/usr/local/src/conda/perl-5.32.1 -fdebug-prefix-map=/opt/conda=/usr/local/src/conda-prefix -D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -fstack-protector-strong -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2 -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64
OPTIMIZE = -O2
PERLTYPE = 
MPOLLUTE = 
...
# Inline::Python might depend on some other libraries:
# See ExtUtils::Liblist for details
#
EXTRALIBS = -L/opt/conda/lib -lpython3.9 -lrt
LDLOADLIBS = -L/opt/conda/lib -lpython3.9 -lcrypt -lpthread -ldl -lutil -lrt -lm
BSLOADLIBS = 
LD_RUN_PATH = /opt/conda/lib:/opt/conda/bin/../x86_64-conda-linux-gnu/sysroot/usr/lib
